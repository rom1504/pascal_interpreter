(** Convert a program to a call graph *)
...
(** A call graph is a map with key identifier and value an identifier*bool set : the bool is used to indicate whether the arc is a terminal call or not *)
...
(** Add arcs to the call graph from an expression *)
...
(** Add arcs to the call graph from an expression list *)
...
(** Add arcs to the call graph from a condition *)
...
(** Add arcs to the call graph from an instruction *)
...
(** Add arcs to the call graph from an instruction list *)
...
(** Add arcs to the call graph from a function definition *)
...
(** Add arcs to the call graph from a procedure definition *)
...
(** Add arcs to the call graph from a procedure or function definition *)
...
(** Add arcs to the call graph from a procedure or function definition list *)
...
(** Add arcs to the call graph from a program *)
